...
int pmic_ricoh619_init(unsigned char bus)
{
	...
	i2c_reg_write(ricoh619.pmic->hw.i2c.addr,0x4e,0x60);// ldo3 output 3.3v for vcc_lcd
	i2c_reg_write(ricoh619.pmic->hw.i2c.addr,0x44,i2c_reg_read(ricoh619.pmic->hw.i2c.addr,0x44)|(3<<5));//ldo6 enable
	i2c_reg_write(ricoh619.pmic->hw.i2c.addr,0x44,i2c_reg_read(ricoh619.pmic->hw.i2c.addr,0x44)|(1<<2));//ldo3 enable
