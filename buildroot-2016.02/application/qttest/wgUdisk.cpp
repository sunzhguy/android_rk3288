...
wgUdisk::wgUdisk(QWidget *parent, QString caption) :
		DemoWidget(parent, caption)
{
    ...
    QPushButton * pButton1 = new QPushButton("Udisk Test", this);
...
void wgUdisk::onBtnTestClicked()
{
    m_pEdit->clear();
    cmd->start("/usr/share/demo/udisk.sh");
}

void wgUdisk::readOutput()
{
