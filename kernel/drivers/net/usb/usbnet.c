...
if ((net->dev_addr[0] == 0x00) && (net->dev_addr[1] == 0x00) && (net->dev_addr[2] == 0x00) && (net->dev_addr[3] == 0x00) && (net->dev_addr[4] == 0x00) &&(net->dev_addr[5] == 0x00) )
{
	...
	if (!is_valid_ether_addr(net->dev_addr))
	{
		...
		printk("[MAC] no mac addr in idb, use random macaddr.\n");
